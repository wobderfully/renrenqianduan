        ...
        >
            ...
            <el-form-item prop="type" label="分类">
                <el-select v-model="dataForm.type" clearable>
                    <el-option label="厂区" value="FACTORY"></el-option>
                    <el-option label="部门" value="DEPARTMENT"></el-option>
                    <el-option label="其他" value="OTHER"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item prop="leader" label="负责人">
                <el-select v-model="dataForm.leader" clearable>
                    <el-option
                        v-for="v in leaderList"
                        :key="v.id"
                        :label="v.username"
                        :value="v.id"
                    ></el-option>
  ...
  methods: {
    init () {
      ...
      this.$nextTick(() => {
        ...
        this.$http
          .get('/sys/user/page?page=1&limit=9999999')
          .then(({ data: res }) => {
            if (res.code !== 0) {
        ...
        this.getDeptList().then(() => {
          if (this.dataForm.id) {
            ...
            this.$store.state.user.superAdmin === 1 ||
                        this.$store.state.user.superTenant === 1
          ) {
